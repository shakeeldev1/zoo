...
export default function Hero() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.2)),url('./contact/hero1.jpeg')",
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl px-4 mt-16">
        {/* Main heading */}
        <h1
          className="text-3xl md:text-7xl font-bold leading-tight tracking-tight m"
          data-aos="fade-up"
          style={{
        ...
        {/* Paragraph */}
        <p
          className="mt text-lg md:text-2xl text-[#F2EDE9] leading-relaxed max-w-2xl mx-auto"
        ...
        <div className="mt-10 pb-5 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="bg-gradient-to-b from-[#1B4332]/50 to-[#081C15]/40 md:p-4 rounded-2xl backdrop-blur-md border flex gap-3 items-center justify-center border-[#2D6A4F]/60 transition-all duration-500 group shadow-lg hover:shadow-xl group-hover:scale-105 group-hover:border-yellow-400"
              data-aos="fade-up"
            ...
            >
              ...
              >
                <stat.icon className="text-lg md:text-2xl  text-yellow-400 group-hover:scale-110 transition-transform duration-300" />
              </div>
              <div
                className="text-lg md:text-2xl font-bold text-yellow-400 group-hover:scale-110 transition-transform duration-300 text-center"
                data-aos="zoom-in"
              ...
              <div
                className="text-[#F2EDE9] mt-2 text-md group-hover:text-white transition-colors duration-300 text-center"
                data-aos="fade-in"
